...
import { calculateShippingCost } from "./shippingPricing";
...
export async function getCartOrderData(userId, options = {}) {
  ...
  const shippingCost = calculateShippingCost(pricing.total, { priceScale: 100 });
  const total = pricing.total + shippingCost;
